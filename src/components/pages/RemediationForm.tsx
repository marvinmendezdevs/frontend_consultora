    ...
    return (
        <div>
            <div className="flex justify-between items-center">
                <h1 className="text-xl font-semibold text-indigo-600">Formulario de Remediación</h1>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label className="text-sm font-medium">Tipo de remediación</label>
                    <div className="flex gap-4"> 
                        <input type="text" defaultValue={data.activityLabel === "Remediación Lenguaje" ? "Lenguaje" : "Matemática" } disabled={data.activityLabel} className="w-full border border-gray-300 rounded px-3 py-2 text-sm bg-gray-50 text-gray-800" /> 
                    </div>
                </div>
            ...
            <div className="text-end">
                <button type="submit" className="border border-indigo-600 text-indigo-600 bg-indigo-50 px-4 py-2 rounded hover:bg-indigo-600 hover:text-white mt-5 cursor-pointer">Actualizar</button>
            </div>
        </div>
    );
}
